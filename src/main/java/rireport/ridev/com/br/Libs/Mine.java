...
//				}
     ...
     */
    public static List<Class<?>> getClasses(Main plugin, Class<?> clazzName) {
     ...
     * @return Lista de Classes
     */
    public static List<Class<?>> getClasses(Main plugin, String pkgname) {
        List<Class<?>> lista = new ArrayList<>();
        try {
            Method fileMethod = Main.class.getDeclaredMethod("getFile");
     ...
     */
    public static List<Class<?>> getListeners(Main plugin, String packname) {
     ...
     * @return Som
     */
    public static org.bukkit.Sound getSound(Object object) {
        String str = object.toString().replace("_", "").trim();
    ...
    public static List<String> getSounds(String argument) {
        ...
        for (org.bukkit.Sound enchant : Sound.values()) {
    ...
    public static void removePermission(Player p, String permission) {
        p.addAttachment(Main.getInstance(), permission, false);
    }
